...
遍历第一遍，如果`matrix[i][j]`为 0<img src="./assets/formulas/formula-9a56af90299b.svg" alt="i \ne 0,\ j \ne 0">，就把`matrix[i][0]`和`matrix[0][j]`置为 0。
...
时间复杂度<img src="./assets/formulas/formula-84614e269da7.svg" alt="O(mn)">，空间复杂度<img src="./assets/formulas/formula-4a137b861e8d.svg" alt="O(1)">。
